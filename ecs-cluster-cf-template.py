...
t = Template()
t.add_description("Effect DevOps in AWS: ECS Cluster")
...
t.add_resource(LaunchConfiguration(
    ...
    UserData=Base64(Join('', [
        ...
        " --resource ECSAutoScalingGroup --region ", Ref('AWS::Region'), '\n'
    ])),
...
for reservation in {"CPU", "Memory"}:
    for state, value in states.items():
        t.add_resource(Alarm(
            ...
            AlarmDescription="Alarm if {} reservation too {}".format(reservation, state),
            Namespace="AWS/ECS",
